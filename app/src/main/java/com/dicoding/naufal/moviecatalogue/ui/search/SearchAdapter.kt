...
class SearchAdapter(private val list: MutableList<Film> = mutableListOf(), private val onClickListener: (Film) -> Unit) :
    RecyclerView.Adapter<SearchAdapter.FilmViewHolder>() {
